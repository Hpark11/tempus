...
모임 개설의 오/남용을 방지하기 위해 실명에 가장 가까운 정보인 핸드폰 번호와 자기소개 등을 기입하여 권한을 신청


2. 개설한 커뮤니티 목록

자신이 개설한 커뮤니티 목록을 확인하고 선택함으로써 각각의 관리창을 열 수 있습니다.


3. 개설

이력, 선호 지역, 스토리 등을 입력하여 자신만의 커뮤니티를 구성합니다.


4. 신청 접수

다른 유저로부터 가입 신청을 받으면 허가 및 거절을 통해 인원 통제가 가능

...
//        FirebaseDataService.instance.meetingRef.child("-KdSIzojddGwVzgDiusF").queryOrdered(byChild: Constants.Meetings.wannabe).queryEqual(toValue: "gLW3r9YTXWSe8cJCEd6PsnYfqZ93").observe(.value, with: { (snapshot) in
//            for group in snapshot.children {
//                print(group)
//            }
//        })
//        
//        FirebaseDataService.instance.meetingRef.child("-KdSIzojddGwVzgDiusF").child(Constants.Meetings.wannabe).observe(.value, with: { (snapshot) in
//            if let snapshot = snapshot.children.allObjects as? [FIRDataSnapshot] {
//                
//                for one in snapshot {
//                    if let bannedId = one.value as? String{
//                        if bannedId == "gLW3r9YTXWSe8cJCEd6PsnYfqZ93" {
//                            one.ref.removeValue()
//                        }
//                    }
//                }
...
//                    if let wannabe = data.value as? String {
//                        print(":::::::: value is : \(wannabe)")
//                    }
//                    
...
//        print("\(query)")
//        query.ref.observe(.value, with: { (snapshot) in
//            if let snapshot = snapshot.children.allObjects as? [FIRDataSnapshot] {
//                print(":::::::: value is : \(snapshot)")
//                for data in snapshot {
//                    if let wannabe = data.value as? String {
...
//            if let data = snapshot.value as? Array<String> {
//                print(":::::::: value is : \(data)")
//            }
//            
//            print(":::::::: key is : \(snapshot.key)")
//            FirebaseDataService.instance.meetingRef.child(Constants.Meetings.wannabe).child(snapshot.key).removeValue()
//        })
    }
